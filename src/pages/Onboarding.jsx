      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <button 
            ...
            disabled={loading}
            className="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg border-2 border-transparent hover:border-teal-500 transition-all text-left flex flex-col justify-between h-48"
          >
          ...
          <button 
            ...
            disabled={loading}
            className="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg border-2 border-transparent hover:border-amber-500 transition-all text-left flex flex-col justify-between h-48"
          >
